...
from algos.vdn.replay_buffer import ReplayBuffer

from utils.envs_func import VecRware, DecentralizeRwareWrapper
...
def train(cfgs):
    ...
    envs = DecentralizeRwareWrapper(envs)
    ...
    model_cfgs = dict(obs_dim=envs.obs_dim,
    ...
    agent = VDNAgent(qnet=qnet, env_cfgs=cfgs.env_cfgs)
