...
# from utils.model_func import MultiAgentFCNetwork, RunningMeanStd
...
class QNet(nn.Module):
    def __init__(self, model_cfg, env_cfg) -> None:
        ...
        self.actor_net = FCNet(env_cfg['obs_space'], env_cfg['act_space'], model_cfg['hidden_dim'])
        self.target_net = FCNet(env_cfg['obs_space'], env_cfg['act_space'], model_cfg['hidden_dim'])
